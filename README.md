...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "PAVANA G");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212222230105");
        HAL_Delay(500);
  while (1)
  {
...
## Output screen shots of proteus  :
 ...
 ![image](https://github.com/premalatha-sureshbabu/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/120620842/006bf607-6cfd-4cf0-a869-984b1510d73f)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![image](https://github.com/premalatha-sureshbabu/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/120620842/0d4268d8-0a82-44bd-b507-ab5cc30cfbac)
## Result :
